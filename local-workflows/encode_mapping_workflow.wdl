...
task filter_qc {
    ...
    runtime {
        docker: 'quay.io/encode-dcc/filter:v0.4'
        cpu: '1'
        memory: '4092 MB'
...
task mapping {
    ...
    runtime {
        docker: 'quay.io/encode-dcc/mapping:v0.4'
        cpu: '1'
        memory: '4092 MB'
        disks: 'local-disk 512 HDD'
    }
...
task xcor {
    ...
    runtime {
        docker: 'quay.io/encode-dcc/xcor:v0.4'
        cpu: '1'
        memory: '4092 MB'
        disks: 'local-disk 512 HDD'
    }
...
task post_processing {
    ...
    runtime {
        docker: 'quay.io/encode-dcc/post_mapping:v0.4'
        cpu: '1'
        memory: '4092 MB'
        disks: 'local-disk 512 HDD'
    }
