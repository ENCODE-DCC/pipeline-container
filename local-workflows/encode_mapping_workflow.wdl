...
task mapping {
    ...
    runtime {
        docker: 'quay.io/encode-dcc/mapping:v0.7'
        cpu: '2'
        memory: '17.1 GB'
...
task post_processing {
    ...
    runtime {
        docker: 'quay.io/encode-dcc/post_mapping:v0.7'
        cpu: '2'
        memory: '17.1 GB'
        disks: 'local-disk 420 HDD'
    }
...
task filter_qc {
    ...
    runtime {
        docker: 'quay.io/encode-dcc/filter:v0.7'
        cpu: '2'
        memory: '17.1 GB'
        disks: 'local-disk 420 HDD'
    }
...
task xcor {
    ...
    runtime {
        docker: 'quay.io/encode-dcc/xcor:v0.7'
        cpu: '2'
        memory: '17.1 GB'
        disks: 'local-disk 420 HDD'
    }
